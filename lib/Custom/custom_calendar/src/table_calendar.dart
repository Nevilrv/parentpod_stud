...
class TableCalendar<T> extends StatefulWidget {
  ...
  @override
  State<TableCalendar> createState() => _TableCalendarState<T>();
}
      ...
      children: [
        ...
        Flexible(
          ...
          child: TableCalendarBase(
            ...
            tablePadding: EdgeInsets.zero /*widget.calendarStyle.tablePadding*/,
            ...
            weekNumberBuilder: (BuildContext context, DateTime day) {
              ...
              cell ??= Padding(
                ...
                child: Center(
                  child: Text(
                    weekNumber.toString(),
                    style: widget.calendarStyle.defaultTextStyle,
                  ),
                ),
              );
